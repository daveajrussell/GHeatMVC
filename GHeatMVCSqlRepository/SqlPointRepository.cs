...
using GHeatMVC.SqlDataAccess;
using GHeatMVCSqlRepository.ExtensionMethods;
...
namespace SqlRepositories
{
    public class SqlPointRepository : IPointRepository
    {
        ...
        {
            using (DataSet oSet = SqlHelper.ExecuteDataset(_connectionString, CommandType.StoredProcedure, "[GIS].[GET_POINTS]"))
            {
